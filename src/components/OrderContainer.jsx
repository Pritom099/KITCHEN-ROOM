...
// console.log(cookingItems);
  ...
  const handleCooking = (order) => {
    ...
    return (
        <div id='home' style={{background: randomColor}}>
            <States cookingTotal = {cookingItems.length} orderTotal={orders.length} readyTotal={readyItems.length}></States>
